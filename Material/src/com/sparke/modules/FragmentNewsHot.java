...
public class FragmentNewsHot extends Fragment implements OnRefreshListener {
	...
	private HotNewsTask mTask = null;

	private FragmentNewsHot() {
	}

	public static FragmentNewsHot newInstance() {
		FragmentNewsHot fragment = new FragmentNewsHot();
		return fragment;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (container == null)
			return null;
		View view = inflater.inflate(R.layout.fragment_news_hot, container,
				false);

		mSwipeRefreshLayout = (SwipeRefreshLayout) view
				.findViewById(R.id.news_hot_refresh);
		mSwipeRefreshLayout.setColorSchemeResources(R.color.danny_background,
				R.color.cpb_blue, R.color.cpb_green_dark);
		mSwipeRefreshLayout.setOnRefreshListener(this);
		mRecyclerView = (RecyclerView) view.findViewById(R.id.news_hot_list);
			...
			public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
				...
				if (!loading
					...
					if (currentPage < mSpider.getPages()) {
						...
						params[0] = "1";
						params[1] = WebSite.HOT_NEWS_WEBSITE + "page/"
								+ (currentPage + 1) + "/";
						mTask = (HotNewsTask)(new HotNewsTask().execute(params));
						loading = true;
					} else {
		...
		mSwipeRefreshLayout.postDelayed(new Runnable() {
			...
			public void run() {
				...
				String[] params = new String[2];
				params[0] = "0";
				params[1] = WebSite.HOT_NEWS_WEBSITE;
				mTask = (HotNewsTask)(new HotNewsTask().execute(params));
			}
		}, 1000);
	...
	class HotNewsTask extends AsyncTask<String, Void, ArrayList<News>> {
