...
public class FragmentNewsNotice extends Fragment implements OnRefreshListener {
	...
	private NoticeNewsTask mTask = null;

	public FragmentNewsNotice() {
	}

	public static FragmentNewsNotice newInstance() {
		FragmentNewsNotice fragment = new FragmentNewsNotice();
		return fragment;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (container == null)
			return null;
		View view = inflater.inflate(R.layout.fragment_news_notice, container,
				false);
		mSwipeRefreshLayout = (SwipeRefreshLayout) view
				.findViewById(R.id.news_notice_refresh);
		mSwipeRefreshLayout.setColorSchemeResources(R.color.danny_background,
				R.color.cpb_blue, R.color.cpb_green_dark);
		mSwipeRefreshLayout.setOnRefreshListener(this);
		mRecyclerView = (RecyclerView) view.findViewById(R.id.news_notice_list);
			...
			public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
				...
				if (!loading
					...
					if (currentPage < mSpider.getPages()) {
						...
						params[0] = "1";
						params[1] = WebSite.NOTICE_NEWS_WEBSITE + "page/"
								+ (currentPage + 1) + "/";
						mTask = (NoticeNewsTask) (new NoticeNewsTask().execute(params));
						loading = true;
					} else {
		...
		mSwipeRefreshLayout.postDelayed(new Runnable() {
			...
			public void run() {
				...
				String[] params = new String[2];
				params[0] = "0";
				params[1] = WebSite.NOTICE_NEWS_WEBSITE;
				mTask = (NoticeNewsTask) (new NoticeNewsTask().execute(params));
			}
		}, 1000);
	...
	class NoticeNewsTask extends AsyncTask<String, Void, ArrayList<News>> {
